...
-- =============================================================================
function FieldMouse:GetFlockType()
	return Boids.FLOCK_RATS;
end

-- =============================================================================
function FieldMouse:CreateFlock()
...
-- =============================================================================
function FieldMouse:Event_Activate()
...
-- =============================================================================
function FieldMouse:Event_Deactivate()
	if (self.flock ~= 0) then
...
-- =============================================================================
function FieldMouse:OnProceedFadeArea( player,areaId,fadeCoeff )
	if (self.flock ~= 0) then
