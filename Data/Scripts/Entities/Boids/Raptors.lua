Raptors =
{
	...
	Sounds =
	{
		"",   				-- idle - already handled
		"b_hen_scared",     -- scared
		"b_hen_death",    	-- die
		"c_torch_whoosh1" -- rooster crow
		--"",   -- pickup
		--"",   -- throw
	},
	Animations =
...
-- =============================================================================
function Raptors:GetFlockType()
	return Boids.FLOCK_CHICKENS
end

-- =============================================================================
function Raptors:CreateFlock()
...
-- =============================================================================
function Raptors:Event_Activate()
...
-- =============================================================================
function Raptors:Event_Deactivate()
	if (self.flock ~= 0) then
...
-- =============================================================================
function Raptors:OnProceedFadeArea( player,areaId,fadeCoeff )
	if (self.flock ~= 0) then
