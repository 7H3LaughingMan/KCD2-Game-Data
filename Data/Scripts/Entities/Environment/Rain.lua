Rain = {
	type = "Rain",
	Properties = {
		bEnabled = true, --[0,1,1,"Set this to true/false to turn the rain effect on/off."]
		bIgnoreVisareas = false, --[0,1,1,"Continue to render rain when player is inside a visarea."]
		bDisableOcclusion = false, --[0,1,1,"Don't check if object should be occluded from rain (is under cover)."]
