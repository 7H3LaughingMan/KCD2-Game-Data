...
HMG.Properties.bUsable=true
HMG.Properties.bPickable=false
...
VehicleHMG.Properties.bUsable=true
VehicleHMG.Properties.bPickable=false
...
VTOLHMG.Properties.bUsable=true
VTOLHMG.Properties.bPickable=false
...
AGL.Properties.bUsable=true
AGL.Properties.bPickable=false
...
swarmer.Properties.bPickable=true
swarmer.Properties.bUsable=true

-- =============================================================================
CreateItemTable("Heavy_minigun")

Heavy_minigun.Properties.bPickable=true
Heavy_minigun.Properties.bUsable=true

-- =============================================================================
CreateItemTable("Heavy_mortar")

Heavy_mortar.Properties.bPickable=true
Heavy_mortar.Properties.bUsable=true

-- =============================================================================
CreateItemTable("Grunt_PlasmaRifle")

Grunt_PlasmaRifle.Properties.bPickable=true
Grunt_PlasmaRifle.Properties.bUsable=true

-- =============================================================================
CreateItemTable("plasma_thrower")

plasma_thrower.Properties.bPickable=true
plasma_thrower.Properties.bUsable=true

-- =============================================================================
CreateItemTable("LightningGun")

LightningGun.Properties.bPickable=true
LightningGun.Properties.bUsable=true

-- =============================================================================
CreateItemTable("UseableTurret")

UseableTurret.Properties.bMounted=1
UseableTurret.Properties.bUsable=true
...
Cinematic_VTolMG.Properties.bPickable=false
Cinematic_VTolMG.Properties.bUsable=false
...
function CreateTurret(name)
	...
	Turret.Event_EnableTurret = function(self)
		self.Properties.GunTurret.bEnabled = true
		self:ActivateOutput("TurretEnabled", 1)
	end

	Turret.Event_DisableTurret = function(self)
		self.Properties.GunTurret.bEnabled = false
...
AutoTurret.Properties.bPickable=false

-- =============================================================================
CreateItemTable("RippableTurretGun")

RippableTurretGun.Properties.bMounted=1
RippableTurretGun.Properties.bUsable=true
