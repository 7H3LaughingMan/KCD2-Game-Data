FogVolume =
{
	...
	Properties =
	{
		...
		bActive = true, --[0,1,1,"If true, fog volume will be enabled."]
		...
		color_Emission = { x = 1, y = 1, z = 1 },
		EmissionIntensity = 0, --[0,100,0.1,"Specifies how much luminance (kcd/m2) the fog emits."]
		fHDRDynamic = 0, --[-10,20,0.01,"Specifies how much brighter than the default 255,255,255 white the fog is."]
		bUseGlobalFogColor = false, --[0,1,1,"If true, the Color property is ignored. Instead, the current global fog color is used."]
		...
		bIgnoresVisAreas = false, --[0,1,0,"Controls whether this entity should respond to visareas."]
		bAffectsThisAreaOnly = false, --[0,1,0,"Set this parameter to false to make this entity affect in multiple visareas."]
	},
...
function FogVolume:OnInit()
	self.active = false
	if( self.Properties.bActive == true ) then
...
function FogVolume:Event_Show()
	self:CreateFogVolume()
	EntityCommon.BroadcastEvent(self, "Show")
end
