...
--System.LogToConsole("--> FadeIS "..fadeCoeff.." vDist "..math.Lerp(self.outsideViewDist, self.Properties.MaxViewDist, Math.Sqrt( fadeCoeff )))
...
function ViewDist:FadeViewDist(fadeCoeff)
	...
	System.ViewDistanceSet( math.Lerp(self.outsideViewDist, self.Properties.MaxViewDist, fadeCoeff) )
end
