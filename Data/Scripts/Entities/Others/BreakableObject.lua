...
function BreakableObject:SetPhysicsProperties()
	...
	if (self.bRigidBodyActive == false) then
...
function BreakableObject:Event_Die( sender )
	self:GoDead()
	EntityCommon.BroadcastEvent(self, "Die")
end

-- =============================================================================
function BreakableObject:Event_IsDead( sender )
	EntityCommon.BroadcastEvent(self, "IsDead")
end
...
function BreakableObject:GoDead( deathVector )
	if (deathVector) then
		self.deathVector = table.DeepCopy(deathVector)
	else
...
-- Compose entity
-- =============================================================================
EntityCommon.MakeUsable(BreakableObject)
EntityCommon.MakePickable(BreakableObject)
EntityCommon.MakeTargetableByAI(BreakableObject)
EntityCommon.MakeKillable(BreakableObject)
