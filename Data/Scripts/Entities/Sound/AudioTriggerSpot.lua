-- in function function AudioTriggerSpot:OnPostLoad() "self:Stop()" is called.
-- if entity has bSerializePlayState="0", AudioTriggerSpot will play even after save load.
...
function AudioTriggerSpot:OnPostLoad()
	if ((self.Properties.bSerializePlayState == 1) or (self.Properties.bSerializePlayState == true)) then
